...
public class CheckAccordionsTextTest extends Annotations {
    private final int numberAccordion;
    private final String textAccordionQuestion;
    private final String textAccordionAnswer;

    public CheckAccordionsTextTest(int numberAccordion, String textAccordionQuestion, String textAccordionAnswer) {
